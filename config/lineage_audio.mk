...
ALARM_PATH := vendor/dumb/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dumb/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dumb/prebuilt/common/media/audio/ringtones
